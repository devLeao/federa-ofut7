...
export default function PaginaCurso() {
  ...
  return (
    <main ref={containerRef} className="min-h-screen bg-[#050505] text-white pt-32 pb-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          <motion.div 
            ...
            className="relative"
          >
            <div className="absolute inset-0 bg-fem-red/30 blur-[120px] rounded-full animate-pulse" />
            <div className="relative z-10 rounded-[3rem] overflow-hidden border-2 border-white/10 shadow-2xl rotate-2 group">
              <img 
                src="https://images.unsplash.com/photo-1551958219-acbc608c6377?q=80&w=1000&auto=format&fit=crop" 
                className="w-full h-[500px] object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000 scale-110 group-hover:scale-100"
                alt="Árbitro em treinamento"
              />
              ...
              <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden border-2 border-white/10 shadow-2xl">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl">
                  <div className="flex items-center gap-2 text-fem-red mb-1">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-white">Ex-Árbitro CBF</span>
                  </div>
                  <p className="text-sm font-black uppercase italic">Luiz Gonzaga</p>
                </div>
              </div>
            </div>
        ...
        >
          <div className="relative z-10">
            ...
            <button 
              onClick={() => window.open('https://wa.me/55319XXXXXXXX?text=Gostaria de me inscrever na mentoria do Luiz Gonzaga', '_blank')}
